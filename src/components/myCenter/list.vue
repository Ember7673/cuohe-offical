 ...
 * @LastEditTime: 2020-12-10 09:25:12
...
<template>
  <div class="content">
    ...
    <el-dialog customClass="details customDialog" :title="curItem.name" :visible.sync="curItemVisible" @closed="onClose">
      <div>
        <div v-show="user && Number(user.status) === 6 && curItem.status !==3">
        ...
        <div class="detailContent" v-show="isEdit">
          ...
          <div class="text description">
            <p class="title">需求介绍：</p>
            <el-input type="textarea" :rows="7" placeholder="请详细描述需求" class="descriptionInput" v-model="changeItem.description"></el-input>
          </div>
          <div class="text coo">
            <p class="title">合作方式：</p>
