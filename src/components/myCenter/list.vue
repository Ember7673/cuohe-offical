 ...
 * @LastEditTime: 2020-12-10 00:33:20
...
<template>
  <div class="content">
    ...
    <el-dialog customClass="details customDialog" :title="curItem.name" :visible.sync="curItemVisible"
      @closed="onClose">
      <div>
        <div v-show="user && Number(user.status) === 6">
        ...
        <div class="detailContent" v-show="isEdit">
          <div class="text description">
            ...
            <el-input type="text" placeholder="请输入需求名称" class="descriptionInput" v-model="changeItem.name"></el-input>
          </div>
          <div class="text description">
            <p class="title">需求介绍：</p>
...
<script>
  ...
  export default {
    ...
    props: ['list', 'size', 'pageindex', 'user'],
    data() {
      return {
        curItem: {},
