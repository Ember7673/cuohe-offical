    ...
    <div v-show="isShowRegisterPanel">
      ...
      <el-form :model="registerForm" :rules="registerRules" ref="registerForm" class="demo-ruleForm" label-width="80px"
        ...
        <el-form-item prop="password">
          <el-input type="password" tabindex="2" maxlength="16" :show-password="true" v-model="registerForm.password"
            placeholder="请输入登录密码">
          </el-input>
        </el-form-item>
        <el-form-item prop="repassword">
          <el-input type="password" tabindex="2" maxlength="16" :show-password="true" v-model="registerForm.repassword"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getSMSCode() {
        const me = this;
        me.$refs['registerForm'].validateField(['phone_num'], error => {
          if (!error) {
            const data = {
