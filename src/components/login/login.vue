 ...
 * @LastEditTime: 2020-12-08 11:56:47
  ...
  <div class="login">
    <div class="login-content">
      <div class="login-type">
        <button class="passwordBtn btn-type" :class="isShowPassword ? 'btn-shadow': ''" @click="onShowPassword">账号登录</button>
        <button class="accountBtn btn-type" :class="isShowPassword ? '': 'btn-shadow'" @click="onShowAccount">短信登录</button>
      </div>
      <div v-show="isShowPassword" class="password">
        ...
        <el-form :model="loginForm" :rules="rules" ref="passwordLoginForm" label-width="100px" class="demo-ruleForm">
          ...
          <el-form-item prop="password">
            <el-input type="password" tabindex="2" maxlength="16" :show-password="true" placeholder="请输入密码" v-model="loginForm.password">
            </el-input>
          </el-form-item>
        </el-form>
      </div>
      <div v-show="!isShowPassword" class="account">
        ...
        <el-form :model="loginForm" :rules="rules" ref="accountLoginForm" label-width="100px" class="demo-ruleForm">
          <el-form-item prop="phone_num">
            <el-input class="mobileSignInInput" type="tel" tabindex="1" maxlength="11" placeholder="请输入手机号码" v-model="loginForm.phone_num">
...
export default {
  ...
  methods: {
    ...
    // 状态限制
    limitFn () {
      let status = Number(this.userInfo.status);
      if (status === 0) {
        console.log(status)
