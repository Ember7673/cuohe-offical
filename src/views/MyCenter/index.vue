 ...
 * @LastEditTime: 2020-12-07 18:18:51
      ...
      <div class="r-menu">
        <el-tabs v-model="activeName" @tab-click="handleTabsClick">
          <el-tab-pane label="全部" name="1,2,3,4">
            <listMoudle :list="requirementList" :size="requirementLength" :pageindex="pageindex" @pageChange="pageChange" @refreshList="refreshList"></listMoudle>
          </el-tab-pane>
          <el-tab-pane label="已提交" name="1">
            <listMoudle :list="requirementList" :size="requirementLength" :pageindex="pageindex" @pageChange="pageChange" @refreshList="refreshList"></listMoudle>
          </el-tab-pane>
          <el-tab-pane label="已审核" name="2" :size="requirementLength" :pageindex="pageindex" @pageChange="pageChange" @refreshList="refreshList">
            <listMoudle :list="requirementList"></listMoudle>
          </el-tab-pane>
          <el-tab-pane label="已对接" name="3" :size="requirementLength" :pageindex="pageindex" @pageChange="pageChange" @refreshList="refreshList">
            <listMoudle :list="requirementList"></listMoudle>
          </el-tab-pane>
          <el-tab-pane label="已完成" name="4" :size="requirementLength" :pageindex="pageindex" @pageChange="pageChange" @refreshList="refreshList">
            <listMoudle :list="requirementList"></listMoudle>
          </el-tab-pane>
        </el-tabs>
