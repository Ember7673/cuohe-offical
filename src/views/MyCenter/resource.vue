 ...
 * @LastEditTime: 2020-12-07 23:23:40
      ...
      <div class="r-menu">
        <el-tabs v-model="activeName" @tab-click="handleTabsClick">
          <el-tab-pane label="全部" name="1,2">
            <listMoudle :list="resourcesList" :size="resourcesLength" @pageChange="pageChange" :userInfo="userInfo"
          ...
          <el-tab-pane label="已审核" name="2" :size="resourcesLength" @pageChange="pageChange" :userInfo="userInfo"
