  ...
  <div class="myCenter" v-loading="loading">
    ...
    <div class="right">
      <div class="r-menu">
        <el-tabs v-model="activeName" @tab-click="handleTabsClick">
          <el-tab-pane label="全部" name="1,2">
            <listMoudle :list="resourcesList" :size="resourcesLength" @pageChange="pageChange" :userInfo="userInfo" @refreshList="refreshList"></listMoudle>
          </el-tab-pane>
          <el-tab-pane label="已提交" name="1">
            <listMoudle :list="resourcesList" :size="resourcesLength" @pageChange="pageChange" :userInfo="userInfo" @refreshList="refreshList"></listMoudle>
          </el-tab-pane>
          <el-tab-pane label="已审核" name="2" :size="resourcesLength" @pageChange="pageChange" :userInfo="userInfo" @refreshList="refreshList">
      ...
      <el-dialog customClass="customDialog" title="创建资源" :visible.sync="createRequirementVisible" width="800px">
        <div>
          <el-form :model="createResourceForm" :rules="rules" ref="createResourceForm" label-width="100px" class="demo-ruleForm">
