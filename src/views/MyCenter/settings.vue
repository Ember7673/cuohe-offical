 ...
 * @LastEditTime: 2020-12-10 00:12:18
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="账号设置" name="1">
          <div class="info line">
            ...
            <button class="editorNickname btn"
              @click="nicknameVisible = true;changeInfo.nickname = userInfo.nickname; nicknameExit=false;">编辑</button>
          </div>
          <div class="line">
